	...
	public static void main(String[] args) {
		...
		do {
			try {// INICIAMOS EL TRY --> POR SI EL USUARIO SE EQUIVOCA PUEDA VOLVER A INGRESAR DE
				...
				System.out.println(m);// m VIENE DE MEDICO QUE ES IGUAL A ---> "Gregory","house","m01","c02","hardvard","no usa","diagnostica" ---> DONDE IMPRIMIMOS MEDICO
				...
				System.out.println(is);// is VIENE DE ---> "mark","zuquerver","i02","mo2","harvadr","back","php","face" ---> DONDE IMPRIMIMOS CON is
				// METODO NO ABSTRACTO EN LA CLASE PROFESIONISTA---->EN LA FORMA DE COBRAR
