...
public class MarcaWS {
	MarcaDao dao = null;
	Estatus es = null;
	//http://localhost:9002/CrudMarcaCelular/crudMarcaCelular/MarcaWS/listar
	@Path("listar")
	@GET
	...
	//http://localhost:9002/CrudMarcaCelular/crudMarcaCelular/MarcaWS/guardar
	@Path("guardar")
	@POST
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	...
	//http://localhost:9002/CrudMarcaCelular/crudMarcaCelular/MarcaWS/eliminar
	@Path("eliminar")
	@POST
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	...
	//http://localhost:9002/CrudMarcaCelular/crudMarcaCelular/MarcaWS/buscar
	@Path("buscar")
	@POST
	@Consumes({ MediaType.APPLICATION_JSON })
	@Produces({ MediaType.APPLICATION_JSON })
	...
	//http://localhost:9002/CrudMarcaCelular/crudMarcaCelular/MarcaWS/editar
	@Path("editar")
		@POST
		@Consumes({ MediaType.APPLICATION_JSON })
		@Produces({ MediaType.APPLICATION_JSON })
